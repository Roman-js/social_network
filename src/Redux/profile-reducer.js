...
let initialState = {
    posts: [
        {id: 1, message: 'Hello guys!!', likes: 21, avatar: <img src = {'https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcQerSvdMpPBNcaYMz9JJQrLR5fAHb04_Ie9f1m8OfOb2ngh0y8W'} alt={'avatar'}/>},
        {id: 2, message: 'What are you doing dude?', likes: 44, avatar: <img src = {'https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcQerSvdMpPBNcaYMz9JJQrLR5fAHb04_Ie9f1m8OfOb2ngh0y8W'} alt={'avatar'}/>},
        {id: 3, message: 'Want to check of add some more comment', likes: 89, avatar: <img
...
const profileReducer = (state = initialState, action) => {
    switch (action.type) {
        case ADD_POST: {
            ...
            //let newPost = {id: 4, message: users.newPostText, likes: 0, avatar: users.avatars[0].avatar};
            return {...state,
                newPostText: '',
                posts: [...state.posts,
